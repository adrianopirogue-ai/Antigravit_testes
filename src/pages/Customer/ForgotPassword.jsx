    ...
    const handleResetPassword = async (e) => {
        ...
        try {
            const { error } = await supabase.auth.resetPasswordForEmail(email, {
                redirectTo: `${window.location.origin}${baseUrl}cliente/reset-password`,
            });
        ...
        return (
            <div style={{ display: 'flex', minHeight: 'calc(100vh - 80px)', alignItems: 'center', justifyContent: 'center' }}>
                <div className="glass-card fade-in" style={{ padding: '2.5rem', width: '100%', maxWidth: '420px', textAlign: 'center' }}>
                    ...
                    <Link to="/cliente" className="btn btn-primary" style={{ width: '100%' }}>
                        Voltar ao Login
                    </Link>
                </div>
            </div>
            ...
            <div className="glass-card fade-in" style={{ padding: '2.5rem', width: '100%', maxWidth: '420px' }}>
                <div style={{ textAlign: 'center', marginBottom: '2rem' }}>
                    ...
                    <p style={{ color: 'var(--color-text-muted)' }}>
                        Enviaremos instrucoes para redefinir sua senha
                    </p>
                </div>
                ...
                <div style={{ marginTop: '1.5rem', textAlign: 'center' }}>
                    <Link to="/cliente" style={{ display: 'inline-flex', alignItems: 'center', gap: '0.5rem', color: 'var(--color-primary)', fontSize: '0.9rem' }}>
                        <ArrowLeft size={16} />
                        Voltar ao Login
                    </Link>
                </div>
